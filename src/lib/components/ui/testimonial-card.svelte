<script lang="ts">
	...
	let { testimonial, name, isAnonymous } = $props<{
		testimonial: string;
		name: string;
		isAnonymous: boolean;
	}>();
...
<div
	class="flex h-full flex-col rounded-[2rem] border bg-white p-8 italic shadow-md shadow-brand/10"
>
	<div class="mb-6 text-brand opacity-20">
		<svg
